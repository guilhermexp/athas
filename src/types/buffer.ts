...
export type BufferAction = 
  | { type: 'OPEN_BUFFER'; payload: { path: string; name: string; content: string; isSQLite: boolean; isImage: boolean; isDiff: boolean; isVirtual: boolean } }
  ...
  | { type: 'UPDATE_BUFFER_VIM_STATE'; payload: { id: string; vimMode: string; cursorPosition: number } }
